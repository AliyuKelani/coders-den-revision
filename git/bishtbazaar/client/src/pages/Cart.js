          ...
          <div className="w-1/3 bg-[#fafafa] py-6 px-4">
            <div className=" flex flex-col gap-6 border-b-[1px] border-b-gray-400 pb-6">
              ...
              <p className="flex items-start gap-4 text-base">
                Shipping{" "}
                <span>
                  Bazaar also provides a platform that allows customers to
                  monitor the progress of their shipments from the moment they
                  are dispatched to the final delivery. Our tracking system
                  provides real-time updates and valuable information about the
                  whereabouts of your package, ensuring transparency and peace
                  of mind.
                </span>
              </p>
            </div>
